        ...
        <div className="bg-white/80 backdrop-blur-xl rounded-2xl shadow-xl shadow-gray-200/50 border border-gray-200/60 overflow-hidden">
          ...
          <div className="px-8 pt-8 pb-8">
            ...
            <div className="text-center mb-8">
              ...
              <h1 className="text-2xl font-bold text-gray-800">Lambdata</h1>
            ...
            <div className="grid grid-cols-2 gap-3">
              <button
                type="button"
                className="flex items-center justify-center gap-2 h-10 border border-gray-200 rounded-xl text-sm text-gray-600 hover:bg-gray-50 transition-colors"
              >
